...
function formAlumno(objForm) {
    ...
    var insIdPersonal = objForm.insIdPersonal;
    var insNombres = objForm.insNombres;
    var insApellidoPaterno = objForm.insApellidoPaterno;
    var insApellidoMaterno = objForm.insApellidoMaterno;
    var insDNI = objForm.insDNI;
    var insCorreo = objForm.insCorreo;
    var insTelefono = objForm.insTelefono;
    var idUbigeo = objForm.idUbigeo;
    var insDireccion = objForm.insDireccion;
    var insSexo = objForm.insSexo;
    var insEstadoCivil = objForm.insEstadoCivil;
    var insFNacimiento = objForm.insFNacimiento;
    var insNacionalidad = objForm.insNacionalidad;
    var insIdUsuario = objForm.insIdUsuario;
    var insUsuario = objForm.insUsuario;
    var insPassword = objForm.insPassword;
